...
class TestExtractDataSingleTable:
    def _pipeline(self):
        ...
        p.source_config = GSheetsConfig(
            spreadsheet_id="abc", sheet_name="Sheet1", range="A:Z"
        )
    ...
    def test_extract_emits_one_table_named_table_name(self):
        ...
        # Reads exactly the configured sheet.
        p.client.get_sheet_data.assert_called_once_with("abc", "Sheet1", "A:Z")
